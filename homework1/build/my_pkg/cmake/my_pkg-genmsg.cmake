...
message(STATUS "my_pkg: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imy_pkg:/home/ludovica/RL/homework1/src/my_pkg/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ludovica/RL/homework1/src/my_pkg/msg/my_msg.msg" NAME_WE)
add_custom_target(_my_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_pkg" "/home/ludovica/RL/homework1/src/my_pkg/msg/my_msg.msg" ""
)
...
_generate_msg_cpp(my_pkg
  "/home/ludovica/RL/homework1/src/my_pkg/msg/my_msg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_pkg\")")
  # install generated code
  install(
